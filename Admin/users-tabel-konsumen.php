  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Management Konsumen</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card recent-sales overflow-auto">
        <div class="card-body pb-0">
            <h1 class="card-title">Management Konsumen<span></span></h1>
            <div class="card-body">
            <?php
...
<?php 
    // Read
    $select_query = "SELECT * FROM `users` WHERE `level` IN ('consument') ";
...
?>
            <tbody>
                <tr>
                    ...
                    <a href="users-edit-konsumen.php?uid=<?= $fetch_users ['id'];?>" class="btn btn-success ri-edit-box-fill"></a>
