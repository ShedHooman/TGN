...
if(isset($_POST['submit'])){
  ...
  $select_user = $conn->prepare("SELECT * FROM `users` WHERE fullname = ? AND email = ? AND phone = ?");
  $select_user->execute([$fullname, $email, $phone]);
                ...
                <div class="card-body p-5">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" name="submit" class="btn-register">Submit</button>
                    </div>

                    <p class="text-center text-muted mt-1 mb-4">Having a problem? <a href="#!"
